...
public class Exercise extends ExerciseBase {
     ...
     */
    public ArrayList<Integer> multiply(ArrayList<Integer> numbers, int multiplier) {
        numbers.replaceAll(num -> num * multiplier);
        return numbers;
    }
     ...
     */
    public ArrayList<String> addIngredient(ArrayList<String> list, String appendString) {
     ...
     */
    public ArrayList<String> removeIngredient(ArrayList<String> list, String removeString) {
     ...
     */
    public boolean containsIngredient(ArrayList<String> list, String checkIngredient) {
        return list.contains(checkIngredient);
    }
